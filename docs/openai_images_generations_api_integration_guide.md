...
The `data` includes specific information about the images generated by the model, and the `url` within it is the detailed link to the generated image, as shown in the figure.
